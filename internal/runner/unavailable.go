...
func (u unavailable) Stats(context.Context, ID) (<-chan Stats, error) { return nil, u.err }
func (u unavailable) Inspect(context.Context, ID) (api.State, error)  { return api.State{}, u.err }

func (u unavailable) Exec(context.Context, ID, api.ExecRequest) (api.ExecResult, error) {
